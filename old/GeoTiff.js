...
requirejs(['./WorldWindShim',
    ...
    function (WorldWind,
        ...
        var resourceUrl = "http://neo.sci.gsfc.nasa.gov/servlet/RenderData?si=521094&cs=rgb&format=TIFF&width=360&height=180";
        //";
        ...
        var parserCallback = function (geoTiffReader, xhrStatus) {
            ...
            console.log(geoTiffReader.metadata.bbox);
